...
public class MainVerticleTest extends TestBase {
  ...
  public void testMatchkeyArgs() {
    ...
    JsonObject matchKeyOut = new JsonObject()
        .put("id", matchKey.getString("id"))
        .put("matcher", matchKey.getString("matcher"))
        .put("method", null)
        .put("params", null)
        .put("update", "ingest")
        .put("args", "payload");
  ...
  JsonObject createIsbnMatchKey(String updateValue) {
    JsonObject matchModule = new JsonObject()
        .put("id", "isbn-matcher")
        .put("type", "jsonpath")
        .put("script", "$.inventory.isbn[*]");

    RestAssured.given()
        .header(XOkapiHeaders.TENANT, TENANT_1)
        .header("Content-Type", "application/json")
        .body(matchModule.encode())
        .post("/reservoir/config/modules")
        .then().statusCode(201)
        .contentType("application/json")
  ...
  public void testClustersEmptyKey() {
    ...
    // phase 2: empty match key for first record
  ...
  public void testSru() throws XMLStreamException, IOException, SAXException {
    ...
    s = RestAssured.given()
        .header(XOkapiHeaders.TENANT, TENANT_1)
        .param("query", "rec.id=" + identifiers.get(0).substring(4))
        .param("startRecord", "1")
