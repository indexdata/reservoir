...
public enum CqlFields {
  ...
  POOL_ID("poolId", Storage.CLUSTER_META_TABLE, "match_key_config_id"),
  MATCHKEY_ID("matchkeyId", Storage.CLUSTER_META_TABLE, "match_key_config_id"),
  METHOD("method", Storage.POOL_CONFIG_TABLE, "method"),
  MATCHER("matcher", Storage.POOL_CONFIG_TABLE, "matcher"),
